        ...
        <div className="box-wrapper">
          ...
          <div className=" bg-white rounded flex items-center w-full p-3 shadow-sm border border-gray-200">
            ...
            <div className="select">
              <select name="" id="" defaultValue={'all'} x-model="image_type" className="text-sm outline-none focus:outline-none bg-transparent">
...
const MakeStarList = ( props ) => {
  ...
  for ( s in props.data ) {
    ...
    <li key={so.names.KO} className="flex justify-between gap-x-6 py-5">
...
const Rendering = (props) => {
  ...
  props.onChangeSearchKeyword( props.data )
...
const Header = () => {
  ...
  <div className="hero-headline flex flex-col mb-10 items-center justify-center text-center">
    ...
    <h1 className=" font-bold text-3xl text-gray-900">K-POP IDOL META</h1>
    <p className=" font-base text-base text-gray-600">Search for your favorite artist and check the information!</p>
  </div>
  )
}
   ...
   <>
    <div className="bg-white">
      <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
        <Header/>
        <Search onChangeSearchKeyword={onChangeSearchKeyword}/>

        <h2 className="text-2xl font-bold text-gray-900 mb-10">Kpop-Star</h2>
        <Rendering data={artistInfo} onChangeSearchKeyword={onChangeSearchKeyword}/>
