...
const getStarData = ( txt ) => {
  ...
  for(s in data ){
    ...
    var _t00 = s.toLowerCase() + so.names.KO;
    if( _t.test(_t00) )
    {
      r[ s ]=  so;
...
const Search = (props) => {
  const [search, setSearch] = useState('')
    ...
    var _tttt = e.target.value.toLowerCase().replace(/\s/g, "");
  ...
  return (
    <>
      ...
      <div className="relative min-h-screen flex items-center justify-center">
        ...
        <div className="relative z-20 flex flex-col items-center justify-center px-6 py-12 lg:px-8 w-full max-w-3xl">
          <Header/>
